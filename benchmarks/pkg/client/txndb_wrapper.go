...
var (
	_ ycsb.DB            = (*TxnDbWrapper)(nil)
	_ ycsb.TransactionDB = (*TxnDbWrapper)(nil)
)
...
func (db *TxnDbWrapper) InitThread(
	ctx context.Context,
	threadID int,
	threadCount int,
) context.Context {
...
func (db *TxnDbWrapper) BatchRead(
	ctx context.Context,
	table string,
	keys []string,
	fields []string,
...
func (db *TxnDbWrapper) BatchUpdate(
	ctx context.Context,
	table string,
	keys []string,
	values []string,
...
func (db *TxnDbWrapper) BatchInsert(
	ctx context.Context,
	table string,
	keys []string,
	values []string,
